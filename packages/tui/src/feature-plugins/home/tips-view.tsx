...
const TIPS: Tip[] = [
  ...
  "Use {highlight}oc run{/highlight} for non-interactive scripting",
  "Use {highlight}oc --continue{/highlight} to resume the last session",
  "Use {highlight}oc run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}oc serve{/highlight} for headless API access to OpenCode",
  "Use {highlight}oc run --attach{/highlight} to connect to a running server",
  "Run {highlight}oc upgrade{/highlight} to update to the latest version",
  "Run {highlight}oc auth list{/highlight} to see all configured providers",
  "Run {highlight}oc agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}oc github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}oc debug config{/highlight} to troubleshoot configuration",
