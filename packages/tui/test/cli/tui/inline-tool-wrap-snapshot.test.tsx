  ...
  test("filters malformed nested tool wire data", () => {
    expect(
      parseApplyPatchFiles([
        null,
        { type: "add" },
       { type: "add", relativePath: "a.ts", filePath: "a.ts", patch: "diff", additions: 0, deletions: 0, changed: false },
      ]),
    ).toEqual([
     { type: "add", relativePath: "a.ts", filePath: "a.ts", patch: "diff", additions: 0, deletions: 0, changed: false, movePath: undefined },
    ])
